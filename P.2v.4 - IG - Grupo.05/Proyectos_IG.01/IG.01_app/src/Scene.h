...
public:
	...
	void toggleSquadOrbit() { if (squadTIE != nullptr) squadTIE->toggleOrbit(); };
	void toggleSquadTurn() { if (squadTIE != nullptr) squadTIE->toggleTurn(); };
	void orbitSquad() { if (squadTIE != nullptr) squadTIE->orbit(); };
	void rotateSquad() { if (squadTIE != nullptr) squadTIE->rota(); };
	/*void setPosLight() {
